  ...
  <div style="width: 200px; box-sizing: border-box; margin: 0; padding: 0">
    ...
    <div>
      <div>
        ...
        <p class="text-center"><b>FACTURA ELECTRÓNICA</b> <br /></p>

        <p class="text-center">--------------------</p>

        <div>
          <p class="text-center" style="font-size: 11px"><b>Cliente:</b> {{ info.name }}</p>
          <p class="text-center" style="font-size: 11px"><b>RUC:</b> {{ info.ruc }}</p>
        </div>
  ...
  methods: {
    async getById() {
      try {
        ...
        this.info = status == 200 ? data.data.info_client : {}
      } catch (error) {}
    },
  },
}
